...
Coef = zeros(1,3);
Coef(1) = distribution1.Sigma^2-distribution2.Sigma^2;
Coef(2) = 2*(distribution1.Mean*distribution2.Sigma^2-distribution2.Mean*distribution1.Sigma^2);
Coef(3) = 2*(distribution1.Sigma*distribution2.Sigma)^2*log((distribution2.Sigma*distribution1.Prior)/(distribution1.Sigma*distribution2.Prior))+(distribution1.Sigma*distribution2.Mean)^2-(distribution2.Sigma*distribution1.Mean)^2;
